...
#else
  #if !defined (RP2040_PIO_INTERFACE)// SPI
    //#define DC_C sio_hw->gpio_clr = (1ul << TFT_PIN_DC)
    //#define DC_D sio_hw->gpio_set = (1ul << TFT_PIN_DC)
    #if  defined (RPI_DISPLAY_TYPE) && !defined (MHS_DISPLAY_TYPE)
      #define DC_C digitalWrite(TFT_PIN_DC, LOW);
      #define DC_D digitalWrite(TFT_PIN_DC, HIGH);
    #else
      #define DC_C sio_hw->gpio_clr = (1ul << TFT_PIN_DC)
      #define DC_D sio_hw->gpio_set = (1ul << TFT_PIN_DC)
    #endif
  #else
    // PIO takes control of TFT_PIN_DC
...
////////////////////////////////////////////////////////////////////////////////////////
  ...
  #if !defined (RP2040_PIO_INTERFACE) // SPI
    #if  defined (RPI_DISPLAY_TYPE) && !defined (MHS_DISPLAY_TYPE)
      #define CS_L digitalWrite(TFT_PIN_CS, LOW);
      #define CS_H digitalWrite(TFT_PIN_CS, HIGH);
    #else
      #define CS_L sio_hw->gpio_clr = (1ul << TFT_PIN_CS)
      #define CS_H sio_hw->gpio_set = (1ul << TFT_PIN_CS)
    #endif
  #else // PIO interface display
    #define CS_L sio_hw->gpio_clr = (1ul << TFT_PIN_CS)
    #define CS_H WAIT_FOR_STALL; sio_hw->gpio_set = (1ul << TFT_PIN_CS)
  #endif
#endif
...
////////////////////////////////////////////////////////////////////////////////////////
// Make sure TFT_PIN_MISO is defined if not used to avoid an error message
////////////////////////////////////////////////////////////////////////////////////////
#ifndef TFT_PIN_MISO
...
////////////////////////////////////////////////////////////////////////////////////////
    ...
    #define SCLK_L digitalWrite(TFT_PIN_SCLK, LOW)
    #define SCLK_H digitalWrite(TFT_PIN_SCLK, LOW)
  #else
