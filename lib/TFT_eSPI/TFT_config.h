...
// SPI BUS
    ...
    #if CONFIG_TFT_PIN_MISO != -1
        #define TFT_PIN_MISO      CONFIG_TFT_PIN_MISO
    #endif

    #if CONFIG_TFT_PIN_MOSI == -1
        #error "Invalid MOSI pin. Check TFT_eSPI configuration"
    #else
        #define TFT_PIN_MOSI      CONFIG_TFT_PIN_MOSI
    #endif

    #if CONFIG_TFT_PIN_SCLK == -1
        #error "Invalid Clock pin. Check TFT_eSPI configuration"
    #else
        #define TFT_PIN_SCLK      CONFIG_TFT_PIN_SCLK
    #endif
