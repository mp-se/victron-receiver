...
int8_t pin_TFT_PIN_MOSI; // SPI pins
int8_t pin_TFT_PIN_MISO;
int8_t pin_tft_clk;
int8_t pin_TFT_PIN_CS;

int8_t pin_TFT_PIN_DC;   // Control pins
int8_t pin_tft_rd;
int8_t pin_tft_wr;
int8_t pin_TFT_PIN_RST;
