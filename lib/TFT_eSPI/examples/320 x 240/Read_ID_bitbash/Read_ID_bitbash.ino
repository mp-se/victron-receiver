...
//Mega
//#define TFT_PIN_MOSI  51
//#define TFT_SCK 52
//#define TFT_PIN_CS 47
//#define TFT_PIN_DC  48
//#define TFT_RESET 44

//Micro
//#define TFT_PIN_MOSI  MOSI
//#define TFT_SCK SCK
...
//NodeMCU
#define TFT_PIN_MOSI  D7
#define TFT_SCK D5
#define TFT_PIN_CS D8
...
uint32_t readwrite8(uint8_t cmd, uint8_t bits, uint8_t dummy)
{
    ...
    pinMode(TFT_PIN_MOSI, OUTPUT);
    for (int i = 0; i < 8; i++) {   //send command
        digitalWrite(TFT_PIN_MOSI, (val & 0x80) != 0);
    ...
    pinMode(TFT_PIN_MOSI, INPUT_PULLUP);
