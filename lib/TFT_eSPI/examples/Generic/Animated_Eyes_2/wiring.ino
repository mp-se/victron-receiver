...
You must not define the TFT_PIN_CS pin in the TFT_eSPI library if you are
...
If you are only using one display, then TFT_PIN_CS can be defined in the
TFT_eSPI library.
...
Function    ESP32 pin       TFT 1       TFT 2
 ...
 TFT_PIN_DC        2     ->     DC    ->    DC      // The TFT pin may be named AO
 TFT_PIN_RST       4     ->     RST   ->    RST
