...
if (user.pin_TFT_PIN_MOSI != -1) { Serial.print("MOSI    = "); Serial.print("GPIO "); Serial.println(getPinName(user.pin_TFT_PIN_MOSI)); }
if (user.pin_TFT_PIN_MISO != -1) { Serial.print("MISO    = "); Serial.print("GPIO "); Serial.println(getPinName(user.pin_TFT_PIN_MISO)); }
...
if (user.overlap == true)
{
  Serial.println("Overlap selected, following pins MUST be used:");
                             ...
                             Serial.println("TFT_PIN_CS   = D3  (GPIO 0)\n");

  Serial.println("TFT_PIN_DC and TFT_PIN_RST pins can be user defined");
}
#endif
...
if (user.pin_TFT_PIN_CS != -1) { Serial.print("TFT_PIN_CS   = " + pinNameRef); Serial.println(getPinName(user.pin_TFT_PIN_CS)); }
if (user.pin_TFT_PIN_DC != -1) { Serial.print("TFT_PIN_DC   = " + pinNameRef); Serial.println(getPinName(user.pin_TFT_PIN_DC)); }
if (user.pin_TFT_PIN_RST!= -1) { Serial.print("TFT_PIN_RST  = " + pinNameRef); Serial.println(getPinName(user.pin_TFT_PIN_RST)); }
